...
internal class APIClient {
    ...
    private let endPointRawUrl = "http://api.themoviedb.org/3/discover/movie?api_key=acea91d2bff1c53e6604e4985b6989e2"
    ...
    internal func getMovies(at page: Int = 1, completionHandler: @escaping (HTTPURLResponse?, Data?) -> Void) {
        if let endPointUrl = URL(string: "\(endPointRawUrl)&page=\(page)") {
